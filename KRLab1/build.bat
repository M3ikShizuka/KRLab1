...
set SOURCES="%ProjectDir%main.cpp" "%ProjectDir%readData.cpp"
set SOURCES_Compiler="%ProjectDir%main.cpp" "%ProjectDir%readData.cpp"

set OBJECTS="%ProjectDir%main.obj" "%ProjectDir%readData.obj"
set OBJECTS_Compiler=/Fo"%ProjectDir%main.obj" "%ProjectDir%readData.obj"
...
%CompilerC++%\cl.exe /Fo"readData.obj" /c "readData.cpp" /FAs /EHsc /Od /Ob1 /Oi /Oy- /Z7 /I "%ProjectDir%"
